...
/** Lets the user pick which smart wallet an agent/action should delegate from, when more than
...
export function WalletPicker({
  ...
  return (
    <div className={className}>
      <label className="mb-1 block text-[10px] uppercase tracking-widest text-text-muted">Smart wallet</label>
      <select
        value={value ?? ""}
